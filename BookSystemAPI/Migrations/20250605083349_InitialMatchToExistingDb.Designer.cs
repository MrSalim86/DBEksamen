...
namespace BookSystemAPI.Migrations
{
    ...
    [Migration("20250605083349_InitialMatchToExistingDb")]
    partial class InitialMatchToExistingDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookSystemAPI.Models.Book", b =>
                {
                    ...
                    b.Property<int>("OriginalPublicationYear")
                        .HasColumnType("int")
                        .HasColumnName("original_publication_year");
                    ...
                    b.Property<int>("WorkTextReviewsCount")
                        .HasColumnType("int")
                        .HasColumnName("work_text_reviews_count");
